...
public class SpringWsClientMain {
  ...
  private void getXmlDate () {
    String config = "classpath:com/itedu/spring/integration/ws/test/config/int-ws-config.xml";
    ...
    request.setFilmId("welcome yantingji@126com");
    ...
    System.out.println("365IT学院 Spring WS 例子：" + response.getFilmId() );
    System.exit(0);
  }
