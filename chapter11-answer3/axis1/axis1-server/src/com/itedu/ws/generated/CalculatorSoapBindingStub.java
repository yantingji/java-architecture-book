...
public class CalculatorSoapBindingStub extends org.apache.axis.client.Stub implements com.itedu.ws.generated.Calculator {
    ...
    public int add(int in0, int in1) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("urn:com.itedu.ws.server.calculator", "add"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(in0), new java.lang.Integer(in1)});
  ...
  throw axisFaultException;
    ...
    public int subtract(int in0, int in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:com.itedu.ws.server.calculator", "subtract"));
