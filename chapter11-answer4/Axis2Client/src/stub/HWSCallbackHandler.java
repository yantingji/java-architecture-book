...
/**
 *  HWSCallbackHandler Callback class, Users can extend this class and implement
 *  their own receiveResult and receiveError methods.
 */
public abstract class HWSCallbackHandler {
     ...
     */
    public HWSCallbackHandler(Object clientData) {
     ...
     */
    public void receiveResultecho(stub.HWSStub.EchoResponse result) {
    }
