 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://com.itedu.hello", wsdlLocation = "file:/D:/workspace/chapter11-answer1/bin/HelloService.wsdl")
public class HelloService_Service extends Service {
	...
	private final static QName HELLOSERVICE_QNAME = new QName("http://com.itedu.hello", "HelloService");

	static {
		URL url = null;
		WebServiceException e = null;
		try {
			url = new URL("file:/D:/workspace/chapter11-answer1/bin/HelloService.wsdl");
	...
	public HelloService getHelloServicePort() {
		return super.getPort(new QName("http://com.itedu.hello", "HelloServicePort"), HelloService.class);
	}
	...
	public HelloService getHelloServicePort(WebServiceFeature... features) {
		return super.getPort(new QName("http://com.itedu.hello", "HelloServicePort"), HelloService.class, features);
	}
